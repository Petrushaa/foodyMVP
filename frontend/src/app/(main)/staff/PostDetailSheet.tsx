...
export function PostDetailSheet({
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col bg-[#F4F6F3]">
            {/* ─── Шапка ─── */}
            ...
            <div className="min-h-0 flex-1 overflow-y-auto pb-4">
                {/* ─── Снимки целиком ───
                    ...
                    отклоняют. */}
                {photos.length > 0 ? (
                    <div className="relative bg-[#15291C]">
                        ...
                        {photos.length > 1 && (
                            <>
                                <button
                                    ...
                                    className="absolute top-1/2 left-3 grid size-9 -translate-y-1/2 place-items-center rounded-full bg-black/45 text-white transition disabled:opacity-25"
                                >
                                ...
                                <button
                                    ...
                                    className="absolute top-1/2 right-3 grid size-9 -translate-y-1/2 place-items-center rounded-full bg-black/45 text-white transition disabled:opacity-25"
                                >
