...
# Осей две: кухня и вид. Прежние format/form/diet слили в «вид» ещё
# раньше, но здесь они остались — и порядок видов файлом не задавался
# вовсе, потому что таких значений в базе давно нет.
TAXON_SECTIONS = ('cuisine', 'type')
